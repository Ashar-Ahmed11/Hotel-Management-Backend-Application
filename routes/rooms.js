...
router.get('/allRooms', async (req, res) => {
  try {
    ...
    const allProducts = await Rooms.find()
...
router.get('/singleRoom/:id', async (req, res) => {
  try {
    ...
    const allProducts = await Rooms.findById(req.params.id)
    res.send(allProducts)
...
router.post('/createroom', async (req, res) => {
  try {
    ...
    const newProduct = await Rooms.create(req.body)
    res.send(newProduct)
...
router.post('/editroom/:id', async (req, res) => {
  try {
    ...
    const newProduct = await Rooms.findByIdAndUpdate(req.params.id,{$set:req.body},{new:true})
    res.send(newProduct)
